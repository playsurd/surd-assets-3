function createUnityInstance(t, n, c) {
  ...
  var d, u, h, f, p, m, g, b, v, w = "",
    ...
    S = (document.addEventListener("webkitfullscreenchange", function(e) {
      document.webkitCurrentFullScreenElement === t ? t.style.width && (w = t.style.width, y = t.style.height, t.style.width = "100%", t.style.height = "100%") : w && (t.style.width = w, t.style.height = y, y = w = "")
  ...
  return l.SystemInfo = function() {
    ...
    version: 1
  }, h = "RequestStore", f = "WebAssembly", p = window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB, m = null, x.getInstance = function() {
    return m = m || new x
  ...
  }, x.UnityCacheDatabase = d, x.RequestMetaDataStore = u, x.MaximumCacheSize = 1073741824, x.prototype.loadRequest = function(e) {
    var t = this;
  ...
  }, x), l.cachedFetch = (g = l.UnityCache, b = l.fetchWithProgress, v = l.readBodyWithProgress, function(o, a) {
    ...
    function d(n, r) {
      return fetch(n, r).then(function(e) {
        ...
        return !c.enabled || c.revalidated ? e : 304 === e.status ? (c.revalidated = !0, i.updateRequestMetaData(c.metaData).then(function() {
          P("'" + c.metaData.url + "' successfully revalidated and served from the indexedDB cache")
        }).catch(function(e) {
          P("'" + c.metaData.url + "' successfully revalidated but not stored in the indexedDB cache due to the error: " + e)
          ...
          return c.metaData.size = e.parsedBody.length, Promise.all([i.storeRequest(n, t), i.updateRequestMetaData(c.metaData)]).then(function() {
            P("'" + s + "' successfully downloaded and stored in the indexedDB cache")
          }).catch(function(e) {
            P("'" + s + "' successfully downloaded but not stored in the indexedDB cache due to the error: " + e)
          }), e
        })) : (P("'" + s + "' request failed with status: " + e.status + " " + e.statusText), v(e, r.onProgress, r.enableStreamingDownload))
      })
    }
    return a && (c.control = a.control, c.companyName = a.companyName, c.productName = a.productName, c.productVersion = a.productVersion), c.revalidated = !1, c.metaData = {
      ...
      return e ? (n = e.response, r = e.metaData, c.response = n, c.metaData.size = r.size, c.metaData.updatedAt = r.updatedAt, "immutable" == c.control ? (c.revalidated = !0, i.updateRequestMetaData(r).then(function() {
        P("'" + c.metaData.url + "' served from the indexedDB cache without revalidation")
      ...
      return P("Failed to load '" + c.metaData.url + "' from indexedDB cache due to the error: " + e), b(o, a)
    }) : b(o, a)
    ...
    l.SystemInfo.hasWebGL ? 1 == l.SystemInfo.hasWebGL ? (n = 'Your browser does not support graphics API "WebGL 2" which is required for this content.', "Safari" == l.SystemInfo.browser && parseInt(l.SystemInfo.browserVersion) < 15 && (l.SystemInfo.mobile || 1 < navigator.maxTouchPoints ? n += "\nUpgrade to iOS 15 or later." : n += "\nUpgrade to Safari 15 or later."), t(n)) : l.SystemInfo.hasWasm ? (l.startupErrorHandler = t, c(0), l.postRun.push(function() {
      c(1), delete l.startupErrorHandler, e(S)
