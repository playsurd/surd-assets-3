...
(() => {
	...
	async function loadPackage(metadata) {
		...
		var PACKAGE_NAME = "bin/srb2.data";
		var REMOTE_PACKAGE_BASE = "srb2.data";
		...
		async function fetchRemotePackage(packageName, packageSize) {
			...
			const packageData = new Uint8Array(chunks.map(c => c.length)
				.reduce((a, b) => a + b, 0));
			let offset = 0;
		...
		async function runWithFS(Module) {
			...
			async function processPackageData(arrayBuffer) {
				...
				Module["removeRunDependency"]("datafile_bin/srb2.data")
			}
			Module["addRunDependency"]("datafile_bin/srb2.data");
...
if (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) {
	try {
		scriptDirectory = new URL(".", _scriptName)
			.href
	} catch {} {
		readAsync = async url => {
			...
			for (var i = 0; i < parts.length; i++) {
				...
				if (parts[i] === "..") {
					...
					if (FS.isRoot(current)) {
						path = current_path + "/" + parts.slice(i + 1)
							.join("/");
						nlinks--;
						continue linkloop
					} else {
...
function __localtime_js(time, tmPtr) {
	...
	var summerOffset = new Date(date.getFullYear(), 6, 1)
		.getTimezoneOffset();
...
var __tzset_js = (timezone, daylight, std_name, dst_name) => {
	...
	var extractZone = timezoneOffset => {
		...
		var hours = String(Math.floor(absOffset / 60))
			.padStart(2, "0");
		var minutes = String(absOffset % 60)
			.padStart(2, "0");
		...
		if (canvas) {
			...
			if (Module["elementPointerLock"]) {
				canvas.addEventListener("click", ev => {
					if (!Browser.pointerLock && Browser.getCanvas()
						.requestPointerLock) {
						Browser.getCanvas()
							.requestPointerLock();
						ev.preventDefault()
...
var getEmscriptenSupportedExtensions = ctx => {
	...
	return (ctx.getSupportedExtensions() || [])
	...
	if (pname == 35716) {
		...
		if (!program.maxUniformBlockNameLength) {
			...
			for (var i = 0; i < numActiveUniformBlocks; ++i) {
				program.maxUniformBlockNameLength = Math.max(program.maxUniformBlockNameLength, GLctx.getActiveUniformBlockName(program, i)
					.length + 1)
			}
		}
...
var _emscripten_glGetString = name_ => {
	...
	if (!ret) {
		switch (name_) {
			case 7939:
				ret = stringToNewUTF8(webglGetExtensions()
					.join(" "));
				break;
			case 7936:
			case 7937:
...
var getEnvStrings = () => {
	if (!getEnvStrings.strings) {
		var lang = (globalThis.navigator?.language ?? "C")
			.replace("-", "_") + ".UTF-8";
		var env = {
			USER: "web_user",
			LOGNAME: "web_user",
...
var ASM_CONSTS = {
	...
	2379719: ($0, $1, $2, $3) => {
		...
		SDL2.capture.silenceBuffer.getChannelData(0)
			.fill(0);
	...
	2381412: ($0, $1, $2, $3) => {
		...
		if (SDL2.audioContext.state === "suspended") {
			...
			SDL2.audio.silenceBuffer.getChannelData(0)
				.fill(0);
			var silence_callback = function() {
				if (typeof navigator.userActivation !== "undefined") {
	...
	2384784: () => window.innerWidth,
	2384814: () => window.innerHeight,
	2384845: ($0, $1, $2) => {
		var w = $0;
		var h = $1;
		var pixels = $2;
...
var _COM_ImmedExecute, _pause_loop, _resume_loop, _malloc, _main, _change_resolution, _inject_text, _inject_keycode, _unlock_mouse, _lock_mouse, __emscripten_timeout, _setThrew, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, memory, __indirect_function_table, wasmMemory, wasmTable;

function assignWasmExports(wasmExports) {
	_COM_ImmedExecute = Module["_COM_ImmedExecute"] = wasmExports["fe"];
	_pause_loop = Module["_pause_loop"] = wasmExports["ge"];
	_resume_loop = Module["_resume_loop"] = wasmExports["he"];
	_malloc = wasmExports["ie"];
	_main = Module["_main"] = wasmExports["je"];
	_change_resolution = Module["_change_resolution"] = wasmExports["ke"];
	_inject_text = Module["_inject_text"] = wasmExports["le"];
	_inject_keycode = Module["_inject_keycode"] = wasmExports["me"];
	_unlock_mouse = Module["_unlock_mouse"] = wasmExports["ne"];
	_lock_mouse = Module["_lock_mouse"] = wasmExports["oe"];
	__emscripten_timeout = wasmExports["qe"];
	_setThrew = wasmExports["re"];
	__emscripten_stack_restore = wasmExports["se"];
	__emscripten_stack_alloc = wasmExports["te"];
	_emscripten_stack_get_current = wasmExports["ue"];
	memory = wasmMemory = wasmExports["de"];
	__indirect_function_table = wasmTable = wasmExports["pe"]
}
var wasmImports = {
	cb: ___call_sighandler,
	yb: ___syscall_chdir,
	zb: ___syscall_faccessat,
	...
	Ab: __abort_js,
	eb: __emscripten_runtime_keepalive_clear,
	...
	$a: _eglDestroySurface,
	Mb: _eglGetConfigAttrib,
	V: _eglGetDisplay,
	Ma: _eglGetError,
	sc: _eglInitialize,
	Ua: _eglMakeCurrent,
	...
	u: _emscripten_cancel_main_loop,
	f: _emscripten_clear_timeout,
	U: _emscripten_date_now,
	Ga: _emscripten_exit_fullscreen,
	Ja: _emscripten_exit_pointerlock,
	t: _emscripten_force_exit,
	j: _emscripten_get_device_pixel_ratio,
	g: _emscripten_get_element_css_size,
	X: _emscripten_get_gamepad_status,
	ha: _emscripten_get_main_loop_timing,
	r: _emscripten_get_now,
	Jd: _emscripten_get_num_gamepads,
	La: _emscripten_get_screen_size,
	ma: _emscripten_glActiveTexture,
	la: _emscripten_glAttachShader,
	Ca: _emscripten_glBeginQueryEXT,
	ka: _emscripten_glBindAttribLocation,
	ja: _emscripten_glBindBuffer,
	ia: _emscripten_glBindFramebuffer,
	ga: _emscripten_glBindRenderbuffer,
	fa: _emscripten_glBindTexture,
	ua: _emscripten_glBindVertexArrayOES,
	ea: _emscripten_glBlendColor,
	da: _emscripten_glBlendEquation,
	ca: _emscripten_glBlendEquationSeparate,
	ba: _emscripten_glBlendFunc,
	aa: _emscripten_glBlendFuncSeparate,
	$: _emscripten_glBufferData,
	_: _emscripten_glBufferSubData,
	Z: _emscripten_glCheckFramebufferStatus,
	be: _emscripten_glClear,
	ae: _emscripten_glClearColor,
	$d: _emscripten_glClearDepthf,
	_d: _emscripten_glClearStencil,
	...
	Ea: _emscripten_glDeleteQueriesEXT,
	Nd: _emscripten_glDeleteRenderbuffers,
	Md: _emscripten_glDeleteShader,
	Ld: _emscripten_glDeleteTextures,
	ta: _emscripten_glDeleteVertexArraysOES,
	Kd: _emscripten_glDepthFunc,
	Id: _emscripten_glDepthMask,
	Hd: _emscripten_glDepthRangef,
	Gd: _emscripten_glDetachShader,
	Fd: _emscripten_glDisable,
	Ed: _emscripten_glDisableVertexAttribArray,
	Dd: _emscripten_glDrawArrays,
	pa: _emscripten_glDrawArraysInstancedANGLE,
	qa: _emscripten_glDrawBuffersWEBGL,
	Cd: _emscripten_glDrawElements,
	oa: _emscripten_glDrawElementsInstancedANGLE,
	Bd: _emscripten_glEnable,
	Ad: _emscripten_glEnableVertexAttribArray,
	Ba: _emscripten_glEndQueryEXT,
	zd: _emscripten_glFinish,
	...
	ud: _emscripten_glGenBuffers,
	sd: _emscripten_glGenFramebuffers,
	Fa: _emscripten_glGenQueriesEXT,
	rd: _emscripten_glGenRenderbuffers,
	qd: _emscripten_glGenTextures,
	sa: _emscripten_glGenVertexArraysOES,
	td: _emscripten_glGenerateMipmap,
	...
	jd: _emscripten_glGetError,
	id: _emscripten_glGetFloatv,
	hd: _emscripten_glGetFramebufferAttachmentParameteriv,
	gd: _emscripten_glGetIntegerv,
	ed: _emscripten_glGetProgramInfoLog,
	fd: _emscripten_glGetProgramiv,
	wa: _emscripten_glGetQueryObjecti64vEXT,
	ya: _emscripten_glGetQueryObjectivEXT,
	va: _emscripten_glGetQueryObjectui64vEXT,
	xa: _emscripten_glGetQueryObjectuivEXT,
	za: _emscripten_glGetQueryivEXT,
	...
	cd: _emscripten_glGetShaderiv,
	_c: _emscripten_glGetString,
	...
	Sc: _emscripten_glGetVertexAttribPointerv,
	Uc: _emscripten_glGetVertexAttribfv,
	Tc: _emscripten_glGetVertexAttribiv,
	Rc: _emscripten_glHint,
	Qc: _emscripten_glIsBuffer,
	Pc: _emscripten_glIsEnabled,
	Oc: _emscripten_glIsFramebuffer,
	Nc: _emscripten_glIsProgram,
	Da: _emscripten_glIsQueryEXT,
	Mc: _emscripten_glIsRenderbuffer,
	Lc: _emscripten_glIsShader,
	Kc: _emscripten_glIsTexture,
	ra: _emscripten_glIsVertexArrayOES,
	Jc: _emscripten_glLineWidth,
	Ic: _emscripten_glLinkProgram,
	Hc: _emscripten_glPixelStorei,
	Cb: _emscripten_glPolygonModeWEBGL,
	Gc: _emscripten_glPolygonOffset,
	Eb: _emscripten_glPolygonOffsetClampEXT,
	Aa: _emscripten_glQueryCounterEXT,
	Fc: _emscripten_glReadPixels,
	Ec: _emscripten_glReleaseShaderCompiler,
	Dc: _emscripten_glRenderbufferStorage,
	Cc: _emscripten_glSampleCoverage,
	Bc: _emscripten_glScissor,
	Ac: _emscripten_glShaderBinary,
	zc: _emscripten_glShaderSource,
	yc: _emscripten_glStencilFunc,
	xc: _emscripten_glStencilFuncSeparate,
	wc: _emscripten_glStencilMask,
	vc: _emscripten_glStencilMaskSeparate,
	uc: _emscripten_glStencilOp,
	tc: _emscripten_glStencilOpSeparate,
	rc: _emscripten_glTexImage2D,
	qc: _emscripten_glTexParameterf,
	pc: _emscripten_glTexParameterfv,
	oc: _emscripten_glTexParameteri,
	nc: _emscripten_glTexParameteriv,
	mc: _emscripten_glTexSubImage2D,
	lc: _emscripten_glUniform1f,
	kc: _emscripten_glUniform1fv,
	jc: _emscripten_glUniform1i,
	ic: _emscripten_glUniform1iv,
	...
	Ub: _emscripten_glUniformMatrix2fv,
	...
	na: _emscripten_glVertexAttribDivisorANGLE,
	...
	Ra: _emscripten_resume_main_loop,
	...
	Ia: _emscripten_set_window_title,
	d: _emscripten_sleep,
	mb: _environ_get,
