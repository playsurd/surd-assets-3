function createUnityInstance(t, n, l) {
  ...
  function r(e) {
    ...
    (n += "\n" + (r = r.startsWith(n) ? r.substring(n.length) : r).trim()) && u.stackTraceRegExp && u.stackTraceRegExp.test(n) && x(n, e.filename || t && (t.fileName || t.sourceURL) || "", e.lineno || t && (t.lineNumber || t.line) || 0)
  }
  ...
  var o, u = {
    ...
    cacheControl: function(e) {
      return e == u.dataUrl || e.match(/\.bundle/) ? "must-revalidate" : "no-store"
    },
  ...
  function f(e) {
    document.webkitCurrentFullScreenElement === t ? t.style.width && (s = t.style.width, d = t.style.height, t.style.width = "100%", t.style.height = "100%") : s && (t.style.width = s, t.style.height = d, d = s = "")
  }
  document.addEventListener("webkitfullscreenchange", f), u.deinitializers.push(function() {
    for (var e in u.disableAccessToMediaDevices(), a.forEach(function(e) {
        t.removeEventListener(e, i)
      }), window.removeEventListener("error", r), window.removeEventListener("unhandledrejection", r), document.removeEventListener("webkitfullscreenchange", f), u.intervals) window.clearInterval(e);
    u.intervals = {}
  ...
  u.SystemInfo = function() {
    ...
    for (var l = [
      ...
      f = ((f = document.createElement("canvas")) && (d = (h = f.getContext("webgl2")) ? 2 : 0, h || (h = f && f.getContext("webgl")) && (d = 1), h && (r = h.getExtension("WEBGL_debug_renderer_info") && h.getParameter(37446) || h.getParameter(7937))), "undefined" != typeof SharedArrayBuffer),
    ...
    return x(e, "", 0), !0
  }, Error.stackTraceLimit = Math.max(Error.stackTraceLimit || 0, 50), u.readBodyWithProgress = function(a, i, s) {
      ...
      function o() {
        return void 0 === e ? a.arrayBuffer().then(function(e) {
          ...
          if (e.done) {
            ...
            for (var t = new Uint8Array(f), n = (t.set(d, 0), h), r = 0; r < u.length; ++r) t.set(u[r], n), n += u[r].length;
            return t
          }
          return f + e.value.length <= d.length ? (d.set(e.value, f), h = f + e.value.length) : u.push(e.value), f += e.value.length, i({
            type: "progress",
            response: a,
            total: Math.max(c, f),
            loaded: f,
    ...
    version: 1
  }, b = "RequestStore", p = "WebAssembly", g = window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB, w = null, C.getInstance = function() {
    return w = w || new C
  ...
  }, C.UnityCacheDatabase = h, C.RequestMetaDataStore = m, C.MaximumCacheSize = 1073741824, C.prototype.loadRequest = function(e) {
    var t = this;
    ...
    var o = this;
    return void 0 === g ? Promise.reject(new Error("Could not connect to cache: IndexedDB is not supported.")) : void 0 === window.caches ? Promise.reject(new Error("Could not connect to cache: Cache API is not supported.")) : new Promise(function(t, n) {
      try {
        function r() {
    ...
    e.objectStoreNames.contains(m.name) || (t = e.createObjectStore(m.name, {
      keyPath: "url"
    }), ["accessedAt", "updatedAt"].forEach(function(e) {
      t.createIndex(e, e)
    })), e.objectStoreNames.contains(b) && e.deleteObjectStore(b), e.objectStoreNames.contains(p) && e.deleteObjectStore(p)
    ...
    return this.getMetaDataEntries().then(function(e) {
      for (var t = e.metaDataEntries, n = e.cacheSize, r = [], o = [], a = 0; a < t.length; ++a) t[a].version == u.productVersion ? o.push(t[a]) : (r.push(t[a]), n -= t[a].size);
      o.sort(function(e, t) {
        return e.accessedAt - t.accessedAt
      });
      for (a = 0; a < o.length && !(n < C.MaximumCacheSize); ++a) r.push(o[a]), n -= o[a].size;
      return function e() {
        var t;
        return 0 === r.length ? Promise.resolve() : (t = r.pop(), i.cache.delete(t.url).then(function(e) {
          if (e) return r = t.url, new Promise(function(e, t) {
            ...
            n.objectStore(m.name).delete(r), n.oncomplete = e, n.onerror = t
          });
          var r
        }).then(e))
      }()
    })
  }, C), u.cachedFetch = (v = u.UnityCache, y = u.fetchWithProgress, k = u.readBodyWithProgress, function(o, a) {
    var e, t, i = v.getInstance(),
    ...
    function c(n, r) {
      return fetch(n, r).then(function(e) {
        var t;
        return !l.enabled || l.revalidated ? e : 304 === e.status ? (l.revalidated = !0, i.updateRequestMetaData(l.metaData).then(function() {
        ...
        }), k(l.response, r.onProgress, r.enableStreamingDownload)) : 200 == e.status ? (l.response = e, l.metaData.updatedAt = l.metaData.accessedAt, l.revalidated = !0, t = e.clone(), k(e, r.onProgress, r.enableStreamingDownload).then(function(e) {
          return l.metaData.size = e.parsedBody.length, Promise.all([i.storeRequest(n, t), i.updateRequestMetaData(l.metaData)]).then(function() {
        ...
        })) : (E("'" + s + "' request failed with status: " + e.status + " " + e.statusText), k(e, r.onProgress, r.enableStreamingDownload))
      })
    }
    return a && (l.control = a.control, l.companyName = a.companyName, l.productName = a.productName, l.productVersion = a.productVersion), l.revalidated = !1, l.metaData = {
      url: s,
      accessedAt: Date.now(),
      version: l.productVersion
    }, l.response = null, l.enabled ? i.loadRequest(s).then(function(e) {
      var n, r, t;
      return e ? (n = e.response, r = e.metaData, l.response = n, l.metaData.size = r.size, l.metaData.updatedAt = r.updatedAt, "immutable" == l.control ? (l.revalidated = !0, i.updateRequestMetaData(r).then(function() {
        E("'" + l.metaData.url + "' served from the indexedDB cache without revalidation")
      }), k(n, a.onProgress, a.enableStreamingDownload)) : (e = s, (t = window.location.href.match(/^[a-z]+:\/\/[^\/]+/)) && !e.lastIndexOf(t[0], 0) || !n.headers.get("Last-Modified") && !n.headers.get("ETag") ? (e = (a = a || {}).headers || {}, a.headers = e, n.headers.get("Last-Modified") ? (e["If-Modified-Since"] = n.headers.get("Last-Modified"), e["Cache-Control"] = "no-cache") : n.headers.get("ETag") && (e["If-None-Match"] = n.headers.get("ETag"), e["Cache-Control"] = "no-cache"), c(o, a)) : fetch(s, {
        method: "HEAD"
      }).then(function(t) {
        return l.revalidated = ["Last-Modified", "ETag"].every(function(e) {
          return !n.headers.get(e) || n.headers.get(e) == t.headers.get(e)
        }), l.revalidated ? (i.updateRequestMetaData(r).then(function() {
          E("'" + l.metaData.url + "' successfully revalidated and served from the indexedDB cache")
        }), k(l.response, a.onProgress, a.enableStreamingDownload)) : c(o, a)
      }))) : c(o, a)
    }).catch(function(e) {
      return E("Failed to load '" + l.metaData.url + "' from indexedDB cache due to the error: " + e), y(o, a)
    }) : y(o, a)
  });
  var D = {
    gzip: {
        ...
        var t, n = {
          "inflate.js": function(e, t, n) {
            ...
            function i(e) {
              ...
              var t = this.options;
              if (t.raw && 0 <= t.windowBits && t.windowBits < 16 && (t.windowBits = -t.windowBits, 0 === t.windowBits && (t.windowBits = -15)), !(0 <= t.windowBits && t.windowBits < 16) || e && e.windowBits || (t.windowBits += 32), 15 < t.windowBits && t.windowBits < 48 && 0 == (15 & t.windowBits) && (t.windowBits |= 15), this.err = 0, this.msg = "", this.ended = !1, this.chunks = [], this.strm = new o, this.strm.avail_out = 0, (e = u.inflateInit2(this.strm, t.windowBits)) !== m.Z_OK) throw new Error(r[e]);
              this.header = new a, u.inflateGetHeader(this.strm, this.header)
            }
            ...
            i.prototype.push = function(e, t) {
              ...
              r = t === ~~t ? t : !0 === t ? m.Z_FINISH : m.Z_NO_FLUSH, "string" == typeof e ? s.input = h.binstring2buf(e) : "[object ArrayBuffer]" === b.call(e) ? s.input = new Uint8Array(e) : s.input = e, s.next_in = 0, s.avail_in = s.input.length;
              do {
                if (0 === s.avail_out && (s.output = new f.Buf8(l), s.next_out = 0, s.avail_out = l), (n = u.inflate(s, m.Z_NO_FLUSH)) === m.Z_NEED_DICT && c && (i = "string" == typeof c ? h.string2buf(c) : "[object ArrayBuffer]" === b.call(c) ? new Uint8Array(c) : c, n = u.inflateSetDictionary(this.strm, i)), n === m.Z_BUF_ERROR && !0 === d && (n = m.Z_OK, d = !1), n !== m.Z_STREAM_END && n !== m.Z_OK) return this.onEnd(n), !(this.ended = !0)
              } while (!s.next_out || 0 !== s.avail_out && n !== m.Z_STREAM_END && (0 !== s.avail_in || r !== m.Z_FINISH && r !== m.Z_SYNC_FLUSH) || ("string" === this.options.to ? (i = h.utf8border(s.output, s.next_out), o = s.next_out - i, a = h.buf2string(s.output, i), s.next_out = o, s.avail_out = l - o, o && f.arraySet(s.output, s.output, i, o, 0), this.onData(a)) : this.onData(f.shrinkBuf(s.output, s.next_out))), 0 === s.avail_in && 0 === s.avail_out && (d = !0), (0 < s.avail_in || 0 === s.avail_out) && n !== m.Z_STREAM_END);
              return (r = n === m.Z_STREAM_END ? m.Z_FINISH : r) === m.Z_FINISH ? (n = u.inflateEnd(this.strm), this.onEnd(n), this.ended = !0, n === m.Z_OK) : r !== m.Z_SYNC_FLUSH || (this.onEnd(m.Z_OK), !(s.avail_out = 0))
            }, i.prototype.onData = function(e) {
              this.chunks.push(e)
            }, i.prototype.onEnd = function(e) {
              e === m.Z_OK && ("string" === this.options.to ? this.result = this.chunks.join("") : this.result = f.flattenChunks(this.chunks)), this.chunks = [], this.err = e, this.msg = this.strm.msg
          ...
          "utils/strings.js": function(e, t, n) {
            ...
            for (var c = new l.Buf8(256), r = 0; r < 256; r++) c[r] = 252 <= r ? 6 : 248 <= r ? 5 : 240 <= r ? 4 : 224 <= r ? 3 : 192 <= r ? 2 : 1;
          ...
          "zlib/inflate.js": function(e, t, n) {
            ...
            function i(e) {
              var t;
              return e && e.state ? (t = e.state, e.total_in = e.total_out = t.total = 0, e.msg = "", t.wrap && (e.adler = 1 & t.wrap), t.mode = N, t.last = 0, t.havedict = 0, t.dmax = 32768, t.head = null, t.hold = 0, t.bits = 0, t.lencode = t.lendyn = new T.Buf32(r), t.distcode = t.distdyn = new T.Buf32(o), t.sane = 1, t.back = -1, z) : O
            }

            function s(e) {
              var t;
              return e && e.state ? ((t = e.state).wsize = 0, t.whave = 0, t.wnext = 0, i(e)) : O
            }

            function l(e, t) {
              var n, r;
              return !e || !e.state || (r = e.state, t < 0 ? (n = 0, t = -t) : (n = 1 + (t >> 4), t < 48 && (t &= 15)), t && (t < 8 || 15 < t)) ? O : (null !== r.window && r.wbits !== t && (r.window = null), r.wrap = n, r.wbits = t, s(e))
            }

            function c(e, t) {
              var n;
              return e ? (n = new a, (e.state = n).window = null, (n = l(e, t)) !== z && (e.state = null), n) : O
            }
            var M, H, Z = !0;

            function j(e, t, n, r) {
              var o;
              return null === (e = e.state).window && (e.wsize = 1 << e.wbits, e.wnext = 0, e.whave = 0, e.window = new T.Buf8(e.wsize)), r >= e.wsize ? (T.arraySet(e.window, t, n - e.wsize, e.wsize, 0), e.wnext = 0, e.whave = e.wsize) : (r < (o = e.wsize - e.wnext) && (o = r), T.arraySet(e.window, t, n - r, o, e.wnext), (r -= o) ? (T.arraySet(e.window, t, n - r, r, 0), e.wnext = r, e.whave = e.wsize) : (e.wnext += o, e.wnext === e.wsize && (e.wnext = 0), e.whave < e.wsize && (e.whave += o))), 0
            }
            n.inflateReset = s, n.inflateReset2 = l, n.inflateResetKeep = i, n.inflateInit = function(e) {
              return c(e, 15)
            }, n.inflateInit2 = c, n.inflate = function(e, t) {
              var n, r, o, a, i, s, l, c, d, u, f, h, m, b, p, g, w, v, y, k, _, x, S, C, E = 0,
                U = new T.Buf8(4),
                D = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
              if (!e || !e.state || !e.output || !e.input && 0 !== e.avail_in) return O;
              12 === (n = e.state).mode && (n.mode = 13), i = e.next_out, o = e.output, l = e.avail_out, a = e.next_in, r = e.input, s = e.avail_in, c = n.hold, d = n.bits, u = s, f = l, x = z;
              e: for (;;) switch (n.mode) {
                case N:
                  if (0 === n.wrap) n.mode = 13;
                    ...
                    if (2 & n.wrap && 35615 === c) U[n.check = 0] = 255 & c, U[1] = c >>> 8 & 255, n.check = P(n.check, U, 2, 0), d = c = 0, n.mode = 2;
                    else if (n.flags = 0, n.head && (n.head.done = !1), !(1 & n.wrap) || (((255 & c) << 8) + (c >> 8)) % 31) e.msg = "incorrect header check", n.mode = 30;
                    else if (8 != (15 & c)) e.msg = "unknown compression method", n.mode = 30;
                    else {
                      if (d -= 4, _ = 8 + (15 & (c >>>= 4)), 0 === n.wbits) n.wbits = _;
                      else if (_ > n.wbits) {
                        e.msg = "invalid window size", n.mode = 30;
                        break
                      }
                      n.dmax = 1 << _, e.adler = n.check = 1, n.mode = 512 & c ? 10 : 12, d = c = 0
                    }
                  }
                  break;
                case 2:
                  ...
                  n.head && (n.head.text = c >> 8 & 1), 512 & n.flags && (U[0] = 255 & c, U[1] = c >>> 8 & 255, n.check = P(n.check, U, 2, 0)), d = c = 0, n.mode = 3;
                case 3:
                  for (; d < 32;) {
                    if (0 === s) break e;
                    s--, c += r[a++] << d, d += 8
                  }
                  n.head && (n.head.time = c), 512 & n.flags && (U[0] = 255 & c, U[1] = c >>> 8 & 255, U[2] = c >>> 16 & 255, U[3] = c >>> 24 & 255, n.check = P(n.check, U, 4, 0)), d = c = 0, n.mode = 4;
                case 4:
                  for (; d < 16;) {
                    if (0 === s) break e;
                    s--, c += r[a++] << d, d += 8
                  }
                  n.head && (n.head.xflags = 255 & c, n.head.os = c >> 8), 512 & n.flags && (U[0] = 255 & c, U[1] = c >>> 8 & 255, n.check = P(n.check, U, 2, 0)), d = c = 0, n.mode = 5;
                case 5:
                  if (1024 & n.flags) {
                    for (; d < 16;) {
                      if (0 === s) break e;
                    ...
                    n.length = c, n.head && (n.head.extra_len = c), 512 & n.flags && (U[0] = 255 & c, U[1] = c >>> 8 & 255, n.check = P(n.check, U, 2, 0)), d = c = 0
                  } else n.head && (n.head.extra = null);
                  n.mode = 6;
                case 6:
                  if (1024 & n.flags && ((h = s < (h = n.length) ? s : h) && (n.head && (_ = n.head.extra_len - n.length, n.head.extra || (n.head.extra = new Array(n.head.extra_len)), T.arraySet(n.head.extra, r, a, h, _)), 512 & n.flags && (n.check = P(n.check, r, h, a)), s -= h, a += h, n.length -= h), n.length)) break e;
                  n.length = 0, n.mode = 7;
                case 7:
                  if (2048 & n.flags) {
                    if (0 === s) break e;
                    for (h = 0; _ = r[a + h++], n.head && _ && n.length < 65536 && (n.head.name += String.fromCharCode(_)), _ && h < s;);
                    if (512 & n.flags && (n.check = P(n.check, r, h, a)), s -= h, a += h, _) break e
                ...
                case 11:
                  if (0 === n.havedict) return e.next_out = i, e.avail_out = l, e.next_in = a, e.avail_in = s, n.hold = c, n.bits = d, 2;
                    ...
                    switch (n.last = 1 & c, --d, 3 & (c >>>= 1)) {
                      ...
                      case 1:
                        var B, B = A = void 0,
                          A = n;
                        if (Z) {
                          for (M = new T.Buf32(512), H = new T.Buf32(32), B = 0; B < 144;) A.lens[B++] = 8;
                          for (; B < 256;) A.lens[B++] = 9;
                          for (; B < 280;) A.lens[B++] = 7;
                          for (; B < 288;) A.lens[B++] = 8;
                          for (L(1, A.lens, 0, 288, M, 0, A.work, {
                              bits: 9
                            }), B = 0; B < 32;) A.lens[B++] = 5;
                        ...
                        if (A.lencode = M, A.lenbits = 9, A.distcode = H, A.distbits = 5, n.mode = 20, 6 !== t) break;
                        c >>>= 2, d -= 2;
                        break e;
                      case 2:
                        n.mode = 17;
                ...
                case 14:
                  ...
                  if (n.length = 65535 & c, d = c = 0, n.mode = 15, 6 === t) break e;
                case 15:
                  n.mode = 16;
                case 16:
                  if (h = n.length) {
                    if (0 === (h = l < (h = s < h ? s : h) ? l : h)) break e;
                    T.arraySet(o, r, a, h, i), s -= h, a += h, l -= h, i += h, n.length -= h
                  } else n.mode = 12;
                  break;
                case 17:
                  for (; d < 14;) {
                  ...
                  if (n.nlen = 257 + (31 & c), c >>>= 5, d -= 5, n.ndist = 1 + (31 & c), c >>>= 5, d -= 5, n.ncode = 4 + (15 & c), c >>>= 4, d -= 4, 286 < n.nlen || 30 < n.ndist) {
                ...
                case 18:
                  ...
                  if (n.lencode = n.lendyn, n.lenbits = 7, S = {
                      bits: n.lenbits
                    }, x = L(0, n.lens, 0, 19, n.lencode, 0, n.work, S), n.lenbits = S.bits, x) {
                ...
                case 19:
                  for (; n.have < n.nlen + n.ndist;) {
                    for (; g = (E = n.lencode[c & (1 << n.lenbits) - 1]) >>> 16 & 255, w = 65535 & E, !((p = E >>> 24) <= d);) {
                      if (0 === s) break e;
                      s--, c += r[a++] << d, d += 8
                    }
                    if (w < 16) c >>>= p, d -= p, n.lens[n.have++] = w;
                    else {
                      if (16 === w) {
                        for (C = p + 2; d < C;) {
                          if (0 === s) break e;
                        ...
                        _ = n.lens[n.have - 1], h = 3 + (3 & c), c >>>= 2, d -= 2
                      } else if (17 === w) {
                        for (C = p + 3; d < C;) {
                          if (0 === s) break e;
                          s--, c += r[a++] << d, d += 8
                        }
                        _ = 0, h = 3 + (7 & (c >>>= p)), c >>>= 3, d = d - p - 3
                      } else {
                        for (C = p + 7; d < C;) {
                          if (0 === s) break e;
                          s--, c += r[a++] << d, d += 8
                        }
                        _ = 0, h = 11 + (127 & (c >>>= p)), c >>>= 7, d = d - p - 7
                      }
                  ...
                  if (n.lenbits = 9, S = {
                      bits: n.lenbits
                    }, x = L(1, n.lens, 0, n.nlen, n.lencode, 0, n.work, S), n.lenbits = S.bits, x) {
                    e.msg = "invalid literal/lengths set", n.mode = 30;
                    break
                  }
                  if (n.distbits = 6, n.distcode = n.distdyn, S = {
                      bits: n.distbits
                    }, x = L(2, n.lens, n.nlen, n.ndist, n.distcode, 0, n.work, S), n.distbits = S.bits, x) {
                ...
                case 21:
                  if (6 <= s && 258 <= l) {
                    e.next_out = i, e.avail_out = l, e.next_in = a, e.avail_in = s, n.hold = c, n.bits = d, I(e, f), i = e.next_out, o = e.output, l = e.avail_out, a = e.next_in, r = e.input, s = e.avail_in, c = n.hold, d = n.bits, 12 === n.mode && (n.back = -1);
                    break
                  }
                  for (n.back = 0; g = (E = n.lencode[c & (1 << n.lenbits) - 1]) >>> 16 & 255, w = 65535 & E, !((p = E >>> 24) <= d);) {
                    if (0 === s) break e;
                    s--, c += r[a++] << d, d += 8
                  }
                  if (g && 0 == (240 & g)) {
                    for (v = p, y = g, k = w; g = (E = n.lencode[k + ((c & (1 << v + y) - 1) >> v)]) >>> 16 & 255, w = 65535 & E, !(v + (p = E >>> 24) <= d);) {
                      if (0 === s) break e;
                      s--, c += r[a++] << d, d += 8
                    }
                    c >>>= v, d -= v, n.back += v
                  }
                  if (c >>>= p, d -= p, n.back += p, n.length = w, 0 === g) {
                    n.mode = 26;
                    break
                  }
                  if (32 & g) {
                ...
                case 23:
                  for (; g = (E = n.distcode[c & (1 << n.distbits) - 1]) >>> 16 & 255, w = 65535 & E, !((p = E >>> 24) <= d);) {
                    if (0 === s) break e;
                    s--, c += r[a++] << d, d += 8
                  }
                  if (0 == (240 & g)) {
                    for (v = p, y = g, k = w; g = (E = n.distcode[k + ((c & (1 << v + y) - 1) >> v)]) >>> 16 & 255, w = 65535 & E, !(v + (p = E >>> 24) <= d);) {
                      if (0 === s) break e;
                      s--, c += r[a++] << d, d += 8
                    }
                    c >>>= v, d -= v, n.back += v
                  }
                  if (c >>>= p, d -= p, n.back += p, 64 & g) {
                ...
                case 25:
                  ...
                  if (n.offset > (h = f - l)) {
                    ...
                    m = h > n.wnext ? (h -= n.wnext, n.wsize - h) : n.wnext - h, h > n.length && (h = n.length), b = n.window
                  } else b = o, m = i - n.offset, h = n.length;
                  for (l -= h = l < h ? l : h, n.length -= h; o[i++] = b[m++], --h;);
                ...
                case 27:
                  if (n.wrap) {
                    ...
                    if (f -= l, e.total_out += f, n.total += f, f && (e.adler = n.check = (n.flags ? P : R)(n.check, o, f, i - f)), f = l, (n.flags ? c : F(c)) !== n.check) {
              ...
              var t;
              return e && e.state ? ((t = e.state).window && (t.window = null), e.state = null, z) : O
            }, n.inflateGetHeader = function(e, t) {
              return e && e.state && 0 != (2 & (e = e.state).wrap) ? ((e.head = t).done = !1, z) : O
            }, n.inflateSetDictionary = function(e, t) {
              var n, r = t.length;
              return !e || !e.state || 0 !== (n = e.state).wrap && 11 !== n.mode ? O : 11 === n.mode && R(1, t, r, 0) !== n.check ? -3 : j(e, t, r, r) ? (n.mode = 31, -4) : (n.havedict = 1, z)
          ...
          "zlib/inffast.js": function(e, t, n) {
            ...
            t.exports = function(e, t) {
              var n, r, o, a, i, s, l = e.state,
                ...
                E = (1 << l.distbits) - 1;
              e: do {
                for (_ < 15 && (k += d[c++] << _, _ += 8, k += d[c++] << _, _ += 8), n = x[k & C];;) {
                  if (k >>>= r = n >>> 24, _ -= r, 0 == (r = n >>> 16 & 255)) h[f++] = 65535 & n;
                  else {
                    if (!(16 & r)) {
                      if (0 == (64 & r)) {
                        n = x[(65535 & n) + (k & (1 << r) - 1)];
                    ...
                    for (o = 65535 & n, (r &= 15) && (_ < r && (k += d[c++] << _, _ += 8), o += k & (1 << r) - 1, k >>>= r, _ -= r), _ < 15 && (k += d[c++] << _, _ += 8, k += d[c++] << _, _ += 8), n = S[k & E];;) {
                      if (k >>>= r = n >>> 24, _ -= r, !(16 & (r = n >>> 16 & 255))) {
                        if (0 == (64 & r)) {
                          n = S[(65535 & n) + (k & (1 << r) - 1)];
                          continue
                        }
                      ...
                      if (a = 65535 & n, _ < (r &= 15) && (k += d[c++] << _, (_ += 8) < r && (k += d[c++] << _, _ += 8)), p < (a += k & (1 << r) - 1)) {
              ...
              k &= (1 << (_ -= (o = _ >> 3) << 3)) - 1, e.next_in = c -= o, e.next_out = f, e.avail_in = c < u ? u - c + 5 : 5 - (c - u), e.avail_out = f < b ? b - f + 257 : 257 - (f - b), l.hold = k, l.bits = _
            }
          },
          "zlib/inftrees.js": function(e, t, n) {
            ...
            t.exports = function(e, t, n, r, o, a, i, s) {
              for (var l, c, d, u, f, h, m, b, p, g = s.bits, w = 0, v = 0, y = 0, k = 0, _ = 0, x = 0, S = 0, C = 0, E = 0, U = 0, D = null, B = 0, A = new I.Buf16(16), T = new I.Buf16(16), R = null, P = 0, w = 0; w <= 15; w++) A[w] = 0;
              for (v = 0; v < r; v++) A[t[n + v]]++;
              for (_ = g, k = 15; 1 <= k && 0 === A[k]; k--);
              if (k < _ && (_ = k), 0 === k) o[a++] = 20971520, o[a++] = 20971520, s.bits = 1;
              else {
                for (y = 1; y < k && 0 === A[y]; y++);
                ...
                for (v = 0; v < r; v++) 0 !== t[n + v] && (i[T[t[n + v]]++] = v);
                if (h = 0 === e ? (D = R = i, 19) : 1 === e ? (D = L, B -= 257, R = z, P -= 257, 256) : (D = O, R = N, -1), w = y, f = a, S = v = U = 0, d = -1, u = (E = 1 << (x = _)) - 1, 1 === e && 852 < E || 2 === e && 592 < E) return 1;
                for (;;) {
                  for (p = i[v] < h ? (b = 0, i[v]) : i[v] > h ? (b = R[P + i[v]], D[B + i[v]]) : (b = 96, 0), l = 1 << (m = w - S), y = c = 1 << x; o[f + (U >> S) + (c -= l)] = m << 24 | b << 16 | p | 0, 0 !== c;);
                  for (l = 1 << w - 1; U & l;) l >>= 1;
                  if (U = 0 !== l ? (U & l - 1) + l : 0, v++, 0 == --A[w]) {
                    if (w === k) break;
                    w = t[n + i[v]]
                  }
                  if (_ < w && (U & u) !== d) {
                    for (f += y, C = 1 << (x = w - (S = 0 === S ? _ : S)); x + S < k && !((C -= A[x + S]) <= 0);) x++, C <<= 1;
                    if (E += 1 << x, 1 === e && 852 < E || 2 === e && 592 < E) return 1;
                    o[d = U & u] = _ << 24 | x << 16 | f - a | 0
                  }
                }
                0 !== U && (o[f + U] = w - S << 24 | 64 << 16 | 0), s.bits = _
              }
              return 0
            }
          }
  ...
  function A() {
    Promise.all([B("frameworkUrl").then(function(e) {
      ...
      return new Promise(function(a, e) {
        ...
        }, document.body.appendChild(i), u.deinitializers.push(function() {
    ...
    u.preRun.push(function() {
      u.addRunDependency("dataUrl"), e.then(function(e) {
        ...
        for (n += 4; n < o;) {
          ...
          n += s;
          for (var c = 0, d = l.indexOf("/", c) + 1; 0 < d; c = d, d = l.indexOf("/", c) + 1) u.FS_createPath(l.substring(0, c), l.substring(c, d - 1), !0, !0);
  ...
  return new Promise(function(e, t) {
    var n;
    u.SystemInfo.hasWebGL ? 1 == u.SystemInfo.hasWebGL ? (n = 'Your browser does not support graphics API "WebGL 2" which is required for this content.', "Safari" == u.SystemInfo.browser && parseInt(u.SystemInfo.browserVersion) < 15 && (u.SystemInfo.mobile || 1 < navigator.maxTouchPoints ? n += "\nUpgrade to iOS 15 or later." : n += "\nUpgrade to Safari 15 or later."), t(n)) : u.SystemInfo.hasWasm ? (u.startupErrorHandler = t, l(0), u.postRun.push(function() {
      l(1), delete u.startupErrorHandler, e(_)
    }), A()) : t("Your browser does not support WebAssembly.") : t("Your browser does not support WebGL.")
  })
}